...
const History = [];
const ai = new GoogleGenAI({ apiKey: "AIzaSyDkjba9AxqvBZ_6fmaoFlEJ6w4BgF_HH1w" });// agar ye api key nahi chale to new key gererate karke use karo google ai studio api generate karke 
